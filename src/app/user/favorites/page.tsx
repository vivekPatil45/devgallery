...
const FavoriteProjectsPage = () => {
    ...
    return (
        ...
        <div className="text-center mb-8">
            ...
            <p className="text-base-content/70 mt-2 text-sm">Projects you've liked from the community</p>
        </div>
        ...
        {currentProjects.length === 0 ? (
            <div className="text-center mt-10 text-gray-500">No favorite projects found.</div>
        ) : (
